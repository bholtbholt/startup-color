...
var _user$project$CheckboxInput$view = function (inputValue) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_elm_lang$html$Html$text(inputValue)
			]));
};
...
var _user$project$RadioInput$view = F4(
	function (inputLabel, inputName, inputValue, msg) {
		return A2(
			_elm_lang$html$Html$label,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$Main$Spotify = {ctor: 'Spotify'};
...
var _user$project$Main$Linkedin = {ctor: 'Linkedin'};
var _user$project$Main$Instagram = {ctor: 'Instagram'};
var _user$project$Main$Google = {ctor: 'Google'};
...
var _user$project$Main$model = {name: '', location: '', revolutionary: _user$project$Main$Yes, market: '', description: _user$project$Main$Airbnb, position: _user$project$Main$ThoughtLeader, color: ''};
